...
define(function() {
  ...
  return ClassicalMechanics = (function() {
    ...
    ClassicalMechanics.prototype.mainloop = function(actors) {
      ...
      this.preSet(this.token);
      this.accumulate(this.token);
      this.apply(this.token);
      return this.postSet(this.token);
    };

    ClassicalMechanics.prototype.preSet = function(token) {
      var actor, behaviour, name, _results;
      _results = [];
      for (name in this.behaviours) {
        behaviour = this.behaviours[name];
        if (behaviour.preSet == null) {
          continue;
        }
        _results.push((function() {
          ...
          for (_i = 0, _len = _ref.length; _i < _len; _i++) {
            ...
            _results1.push(behaviour.preSet(token, actor));
          }
          return _results1;
        })());
      }
    ...
    ClassicalMechanics.prototype.postSet = function(token) {
