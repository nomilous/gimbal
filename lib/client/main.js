...
require(['three', '/js/tools/tools.js', '/js/actors/actors.js', 'realm/ui/user_interface', '/js/realm/engines/classical/classical_mechanics.js', 'realm/visualizer/web_g_l_visualizer', '/js/realm/realm.js'], function(three, tools, actors, UserInterface, ClassicalMechanics, WebGLVisualizer, Realm) {
  var BoundarySphere, SphericalMass, exist, globals, realm, renderer, simulator, ui;
  globals = {
    document: document,
    window: window,
    THREE: THREE,
